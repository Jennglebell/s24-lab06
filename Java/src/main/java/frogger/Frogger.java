...
public class Frogger {
    ...
    * 1. Returning the entire array is redundant.
    *    Just need to check if the particular position is occupied and return the result.
    * 2. Frogger should not be responsible for implementing isOccupied and isValid.
    *    It's Road's responsibility.
    */
